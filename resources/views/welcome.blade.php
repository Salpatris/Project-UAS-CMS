                        ...
                        @if (!is_null($content))
                            <div class="text-center my-5">
                                ...
                                <div class="d-flex justify-content-center fs-2 gap-4">
                                    <a class="text-gradient" href="https://www.instagram.com/salpatris?igsh=b3M5NnY1N2o4ZGlh"><i class="bi bi-instagram"></i></a>
                                    <a class="text-gradient" href="https://youtube.com/@salpatris8564?si=ZcWvBEGls5djdrpX"><i class="bi bi-youtube"></i></a>
                                    <a class="text-gradient" href="https://github.com/Salpatris?tab=repositories"><i class="bi bi-github"></i></a>
                                </div>
                            </div>
                        @else
                            <div class="text-center my-5">
                                ...
                                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit
                                    ...
                                    cumque officiis sed rem iure ipsa! Praesentium ratione atque dolorem?</p>
                                <div class="d-flex justify-content-center fs-2 gap-4">
                                    <a class="text-gradient" href="https://www.instagram.com/salpatris?igsh=b3M5NnY1N2o4ZGlh"><i class="bi bi-instagram"></i></a>
                                    <a class="text-gradient" href="https://youtube.com/@salpatris8564?si=ZcWvBEGls5djdrpX"><i class="bi bi-youtube"></i></a>
                                    <a class="text-gradient" href="https://github.com/Salpatris?tab=repositories"><i class="bi bi-github"></i></a>
